...
public sealed class TechnitiumFixture : IAsyncLifetime
{
    ...
    private const string PluginName = "ParentalControlsApp";
    private const string ClassPath = "ParentalControlsApp.App";
    ...
    private async Task InstallPluginAsync()
    {
        ...
        form.Add(new ByteArrayContent(await File.ReadAllBytesAsync(zipPath)), "appZip", "ParentalControlsApp.zip");
    ...
    private static string FindPluginZip()
    {
        var candidates = new[]
        {
            "/src/app/dist/ParentalControlsApp.zip", // Docker build path
        };
        ...
        for (int i = 0; i < 10; i++)
        {
            var candidate = Path.Combine(dir, "dist", "ParentalControlsApp.zip");
